...
for destination in destinations.keys():
    ...
    for i in range(10):
        ...
        print(unjitted_receeding_horizon_control(START_TIME, ELAPSED_TIME, deterministic_balloon, wind_inst, WithDisturbance(wind_inst, key), key, destinations[destination]))
